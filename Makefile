...
quickjs-ffi:
	$(CC) $(CFLAGS) -shared -fPIC -Wl,--out-implib,libquickjs-ffi.a -Ithird_party -lpthread -ldl -lffi -Lthird_party/quickjs -lquickjs.lto -o $(OUT_DIR)/libquickjs-ffi$(SO) third_party/quickjs-ffi/quickjs-ffi.c
